...
public class FireFrog extends Enemy {
    ...
    public FireFrog(Point startLocation, Point endLocation, Direction facingDirection) {
        super(startLocation.x, startLocation.y, new SpriteSheet(ImageLoader.load("FireFrog.png"), 15, 15), "WALK_RIGHT");
